...
HD_PWD='C:/Users/smkilani/Documents/atfc/firmware/ATFC_demo1/ATFC_demo1.runs/system_microblaze_0_axi_intc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_microblaze_0_axi_intc_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source system_microblaze_0_axi_intc_0.tcl

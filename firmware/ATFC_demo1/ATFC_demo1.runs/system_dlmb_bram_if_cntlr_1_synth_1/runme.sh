...
HD_PWD='C:/Users/smkilani/Documents/atfc/firmware/ATFC_demo1/ATFC_demo1.runs/system_dlmb_bram_if_cntlr_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_dlmb_bram_if_cntlr_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source system_dlmb_bram_if_cntlr_1.tcl

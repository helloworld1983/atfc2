...
HD_PWD='C:/Users/smkilani/Documents/atfc/firmware/ATFC_IBERT/ATFC_IBERT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_ibert_7series_gtp_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_ibert_7series_gtp_0.tcl -notrace

...
HD_PWD='C:/Users/smkilani/Documents/atfc/firmware/ATFC_IBERT/ATFC_IBERT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log example_ibert_7series_gtp_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source example_ibert_7series_gtp_0.tcl

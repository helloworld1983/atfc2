...
HD_PWD='C:/Users/smkilani/Documents/atfc/firmware/ATFC_serdes_fmc/ATFC_serdes_fmc.runs/selectio_wiz_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log selectio_wiz_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source selectio_wiz_1.tcl

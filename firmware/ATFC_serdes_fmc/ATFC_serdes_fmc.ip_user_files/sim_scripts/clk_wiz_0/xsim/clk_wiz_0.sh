...
#
# Generated by Vivado on Mon Dec 04 14:57:19 +0000 2017
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2015.4.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 1c1cad89494b4b1a9a2ce80e821897a4 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot clk_wiz_0 xil_defaultlib.clk_wiz_0 xil_defaultlib.glbl -log elaborate.log
}

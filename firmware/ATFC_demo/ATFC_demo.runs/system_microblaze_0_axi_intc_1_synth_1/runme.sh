...
HD_PWD='C:/Users/smkilani/Documents/atfc/firmware/ATFC_demo/ATFC_demo.runs/system_microblaze_0_axi_intc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_microblaze_0_axi_intc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_microblaze_0_axi_intc_1.tcl

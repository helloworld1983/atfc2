...
HD_PWD='C:/Users/smkilani/Documents/atfc/firmware/ATFC_demo/ATFC_demo.runs/system_selectio_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_selectio_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_selectio_wiz_0_1.tcl

...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xc7a35tfgg484-1
}
...
CONFIG.FREQ_HZ {100000000} \
  ...
  set I_3V3_MON [ create_bd_port -dir I I_3V3_MON ]
  set LA_00_n [ create_bd_port -dir O -from 0 -to 0 -type data LA_00_n ]
  set LA_00_p [ create_bd_port -dir O -from 0 -to 0 LA_00_p ]
  set LA_17_n [ create_bd_port -dir I LA_17_n ]
  set LA_17_p [ create_bd_port -dir I -type data LA_17_p ]
  set VADJ_I_MON [ create_bd_port -dir I VADJ_I_MON ]
...
CONFIG.CONST_WIDTH {8} \
  ...
  # Create port connections
  connect_bd_net -net I_3V3_MON_1 [get_bd_ports I_3V3_MON] [get_bd_pins xadc_wiz_0/vauxn0]
  connect_bd_net -net LA_17_n_1 [get_bd_ports LA_17_n] [get_bd_pins selectio_wiz_1/data_in_from_pins_n]
  connect_bd_net -net LA_17_p_1 [get_bd_ports LA_17_p] [get_bd_pins selectio_wiz_1/data_in_from_pins_p]
  connect_bd_net -net VADJ_I_MON_1 [get_bd_ports VADJ_I_MON] [get_bd_pins xadc_wiz_0/vauxp0]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_ports Clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_Clk_100M/slowest_sync_clk] [get_bd_pins selectio_wiz_0/clk_in] [get_bd_pins selectio_wiz_1/clk_in] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  connect_bd_net -net microblaze_0_intr [get_bd_pins microblaze_0_axi_intc/intr] [get_bd_pins microblaze_0_xlconcat/dout]
  connect_bd_net -net reset_rtl_0_1 [get_bd_ports reset_rtl] [get_bd_pins rst_Clk_100M/ext_reset_in]
  ...
  connect_bd_net -net rst_Clk_100M_peripheral_aresetn1 [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_Clk_100M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  connect_bd_net -net selectio_wiz_0_data_out_to_pins_n [get_bd_ports LA_00_n] [get_bd_pins selectio_wiz_0/data_out_to_pins_n]
  connect_bd_net -net selectio_wiz_0_data_out_to_pins_p [get_bd_ports LA_00_p] [get_bd_pins selectio_wiz_0/data_out_to_pins_p]
  connect_bd_net -net selectio_wiz_1_data_in_to_device [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins selectio_wiz_1/data_in_to_device]
